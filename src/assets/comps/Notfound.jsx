...
export const NotFound = () => {
  return (
    <>
      <SEO 
        title="404 - Página no encontrada | Dota Solutions"
        description="La página que buscas no existe."
        url="https://dotasolutions.agency/404"
        noindex={true}
      />
      <div className="flex flex-col justify-center items-center h-screen w-screen text-center notfound">
        <img src={dota} alt="Dota Solutions - Desarrollo de Sistemas de Gestión & sitios web 100% Personalizados" className="logoNotFound mb-4" />
