      ...
      <div className="max-w-3xl mx-auto p-6 space-y-6 bg-white shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-sm">
            <li>Denominación social: Dota Solutions</li>
            <li>Domicilio social: Empresa digital global sin domicilio físico fijo</li>
          ...
          <p className="text-sm">
            Este sitio web tiene por objeto ofrecer información sobre los servicios de Dota Solutions, especializados en sistemas B2B (Business to Business) de alto rendimiento. Nuestros servicios incluyen:
          </p>
          <ul className="list-disc pl-6 text-sm">
            <li>Desarrollo de sistemas B2B a medida para automatización empresarial</li>
            <li>Plataformas de gestión integral para escalar operaciones</li>
            <li>Soluciones de software enfocadas en retorno de inversión (ROI)</li>
            <li>Centralización de procesos y optimización de flujos de trabajo</li>
            <li>Infraestructura digital para crecimiento masivo</li>
          </ul>
          ...
          <ul className="list-disc pl-6 text-sm space-y-2">
            <li>Cualquier daño directo, indirecto, incidental, especial, consecuente o punitivo</li>
            <li>Pérdidas de beneficios, datos, uso, buena voluntad o cualquier otra pérdida intangible</li>
            <li>Retrasos en entregas, incumplimientos de plazos o especificaciones</li>
            <li>Problemas técnicos, bugs, errores o fallos en los sistemas desarrollados</li>
            <li>Interferencias, omisiones, interrupciones, virus informáticos o desconexiones</li>
            <li>Daños causados por terceros, proveedores o servicios externos</li>
            <li>Cualquier reclamación, demanda o acción legal de cualquier naturaleza</li>
            <li>Costos de reparación, reemplazo o indemnización de cualquier tipo</li>
            <li>Responsabilidad por el uso indebido de los servicios por parte del cliente</li>
            <li>Cualquier consecuencia derivada de cambios en requisitos o especificaciones</li>
          </ul>
          <p className="text-sm">
          ...
          <ul className="list-disc pl-6 text-sm space-y-2">
            ...
            <li>Garantías de que los servicios estarán libres de errores o interrupciones</li>
            <li>Garantías de que los resultados serán exactos o completos</li>
            <li>Garantías de compatibilidad con sistemas o software de terceros</li>
            <li>Garantías de seguridad o protección contra pérdida de datos</li>
            <li>Garantías de cumplimiento de regulaciones específicas o estándares de la industria</li>
          </ul>
          <p className="text-sm">
