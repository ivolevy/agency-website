    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <ul className="list-disc pl-6 text-sm">
          ...
          <li>Domicilio social: Empresa digital sin domicilio físico fijo</li>
        ...
        <ul className="list-disc pl-6 text-sm">
          ...
          <li>Sistemas de gestión a medida (ERP) con automatización total</li>
          <li>Digitalización y centralización de negocios</li>
          <li>Soluciones web completas con SEO y hosting incluido</li>
