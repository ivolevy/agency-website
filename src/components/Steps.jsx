...
export const Steps = () => {
  ...
  return (
    <section className="flex flex-col items-center stepsSection py-16" aria-labelledby="steps-title">
      <h2 id="steps-title" className="text-base mb-4 text-center stepsTitle" style={{ color: '#fff' }}>
        ...
        {steps.map((step, index) => (
          ...
          >
            <div className="w-1/2 flex flex-col items-center p-3 steps">
              <h3 className="text-base font-semibold mt-1 text-center stepsTitleSquare" style={{ color: '#fff' }}>{step.title}</h3>
