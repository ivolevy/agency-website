  ...
  return (
    <section className="contact-section" id="contact" style={{ scrollMarginTop: '200px' }}>
      ...
      <div className="lg:w-1/2 flex flex-col items-start justify-center text-left p-6 responsiveData">
        <h3 className="text-white contactSubtitle" style={{ fontFamily: '"Inter", sans-serif', fontWeight: '400', fontSize: '1.2rem' }}>Cut costs and boost revenue with custom software.</h3>
        <p className="mb-4 contactText" style={{ fontFamily: '"Inter", sans-serif', fontWeight: '300', fontSize: '0.9rem', color: '#d1d1d1' }}>Let's discuss how automation and efficiency can drive your bottom line</p>
